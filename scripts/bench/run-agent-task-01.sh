...
TASK='Tests in tests/test_priority.py are failing in this repository. Fix it so that the whole python3 -m pytest suite passes. Do not break the other tests.'
